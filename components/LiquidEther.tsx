...
`;
    ...
    class Poisson extends ShaderPass {
      ...
      update(...args: any[]) {
        ...
        for (let i = 0; i < iter; i++) {
          ...
          if (this.uniforms) this.uniforms.pressure.value = p_in.texture;this.props.output = p_out;
          super.update();
        }
        return p_out;
      }
    ...
    class Simulation {
      ...
      calcSize() {
        ...
        const height = Math.max(1, Math.round(this.options.resolution * Common.height));this.cellScale.set(1 / width, 1 / height);
